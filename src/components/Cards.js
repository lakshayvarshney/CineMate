...
const Cards = () => {
    ...
    const getData = () => {
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=d851c90c6d62eb4bda3e7e039431ec8b&language=en-US`)
        .then(res => res.json())
    ...
    <>
         <div className="movie">
            <div className="movie__intro">
                <img className="movie__backdrop" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.backdrop_path : ""}`} alt='movieimage' />
            </div>
